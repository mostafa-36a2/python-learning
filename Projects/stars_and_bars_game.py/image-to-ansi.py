...
def translate_color(short:int):
    letters = " .:-=+*#%@"
    return letters[10 * short//256]
...
while rval:
    ...
    #img = Image.open("/home/mostafa/Pictures/Screenshot from 2023-10-16 09-11-25.png")
    ...
    from PIL import Image
    im = img.resize((base_width, hsize), Image.LANCZOS)
    #print(img)
    #print(type(img))
    #img.show()
    #img.save('somepic.png')
    
    #im = Image.open("somepic.png")
    for y in range(im.size[1]):
        for x in range(im.size[0]):
            ...
            #sys.stdout.write(translate_color(int(short)))
        sys.stdout.write("\033[0m\n")
    #sys.stdout.write("\n")
#    import os
    #sys.stdout.write(f'\x1b[0;0H')
    sys.stdout.write(f'\033[0;0H')
    #sys.stdout.write(f'\x1b[640B')
